...
int** dna_alignment (struct alignment* aln, int* tree, float**submatrix, int** map, float strength)
{
  ...
  show_percentage_progress("Alignment (DNA)", current_percentage, stdout);
  ...
  for (i = 0; i < (numseq - 1); i++)
  {
    ...
    if ((int) ( 1.0 * i / numseq * 100) > current_percentage)
    {
      ...
      show_percentage_progress("Alignment (DNA)",
                               current_percentage,
                               stdout);
    }
  ...
  show_percentage_end("Alignment (DNA)", stdout);
...
int** dna_alignment_against_a (struct alignment* aln, int* tree, float**submatrix, int** map, float strength)
{
  ...
  int current_percentage = 0;
  show_percentage_progress("Alignment (DNA Against 'a')",
                           current_percentage,
                           stdout);
  ...
  show_percentage_end("Alignment (DNA Against 'a')", stdout);
  //free(profile[numprofiles-1]);
  free (profile);
  hirsch_mem_free (hm);
