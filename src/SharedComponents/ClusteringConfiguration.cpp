 ...
 */
bool ClusteringConfiguration::Initialize(string XMLFileName, bool   ApplyCPIStack)
{
  FILE*     XMLFile;
  XMLParser Parser;

  this->ApplyCPIStack = ApplyCPIStack;
...
/**
 * Sets the ApplyCPIStack attribute
 */
void
ClusteringConfiguration::SetApplyCPIStack(bool ApplyCPIStack)
{
  this->ApplyCPIStack = ApplyCPIStack;
}

/**
 * Returns the ApplyCPIStack attribute
 * \return True if CPI stack extrapolation parameters should be used
 */
bool
ClusteringConfiguration::GetApplyCPIStack(void)
{
  return ApplyCPIStack;
}
