 ...
 *         otherwise
 */
bool libTraceClusteringImplementation::SetDBSCANParameters(double Eps, int MinPoints)
{
  map<string, string> ClusteringAlgorithmParameters;
  ...
  if (!ClusteringCore->InitClustering (DBSCAN::NAME,
                                       ClusteringAlgorithmParameters))
  {
    SetError(true);
    SetErrorMessage(ClusteringCore->GetErrorMessage());
...
bool libTraceClusteringImplementation::ReconstructInputTrace(string OutputTraceName)
{
  ...
  switch(InputFileType)
  {
    ...
    case DimemasTrace:
      ...
      break;
    case SematicGuided:
       TraceReconstructor = new SemanticGuidedPRVGenerator(InputFileName,
                                                           OutputTraceName);
      break;
    default:
                                                        ...
                                                        string ScriptsFileNamePrefix)
{
  ...
  {
    PlotTitle = "Cluster Analysis Results of trace \'"+string(basename(InputFileName.c_str()))+"\'\\n"+ ClusteringCore->GetClusteringAlgorithmName();
